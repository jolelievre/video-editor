...
This section describes every field so that an AI agent or external tool can generate a valid configuration programmatically.
...
| Field        | Type                | Required | Default      | Description |
| ------------ | ------------------- | -------- | ------------ | ----------- |
| `fontFamily` | `string`            | no       | `"Roboto"`   | Font family name. Must match one of the bundled fonts (see Bundled Fonts section). |
